...
class View:
    ...
    def http_method_not_allowed(self, request, *args, **kwargs) -> CoroutineType[Any, Any, HttpResponseNotAllowed] | HttpResponseNotAllowed:
        ...
    
    def options(self, request, *args, **kwargs) -> CoroutineType[Any, Any, HttpResponse] | HttpResponse:
