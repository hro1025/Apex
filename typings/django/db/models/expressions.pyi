...
class CombinedExpression(SQLiteNumericMixin, Expression):
    ...
    def resolve_expression(self, query=..., allow_joins=..., reuse=..., summarize=..., for_save=...) -> DurationExpression | TemporalSubtraction | Self:
        ...
...
class ColPairs(Expression):
    def __init__(self, alias, targets, sources, output_field) -> None:
        ...
...
class When(Expression):
    ...
    def get_source_fields(self) -> list[Any | cached_property | None]:
        ...
...
class OrderBy(Expression):
    ...
    def as_sql(self, compiler, connection, template=..., **extra_context) -> tuple[LiteralString, list[Any]] | tuple[str | Any, Any]:
        ...
    
    def as_oracle(self, compiler, connection) -> tuple[LiteralString, list[Any]] | tuple[str | Any, Any]:
        ...
