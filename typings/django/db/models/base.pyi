...
class Model(AltersData, metaclass=ModelBase):
    ...
    def delete(self, using=..., keep_parents=...) -> tuple[Any | Literal[0], dict[Any, Any | int]] | tuple[int, dict[Any, int]]:
        ...
    
    async def adelete(self, using=..., keep_parents=...) -> tuple[Any | Literal[0], dict[Any, Any | int]] | tuple[int, dict[Any, int]]:
        ...
