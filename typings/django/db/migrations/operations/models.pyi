...
class AlterTogetherOptionOperation(ModelOptionOperation):
    ...
    def deconstruct(self) -> tuple[str, list[Any], dict[str | None, Any | cached_property]]:
        ...
...
class RenameIndex(IndexOperation):
    ...
    def deconstruct(self) -> tuple[str, list[Any], dict[str, Any | None]]:
        ...
...
class AddConstraint(IndexOperation):
    ...
    def reduce(self, operation, app_label) -> list[Any] | list[AddConstraint] | list[Self] | Literal[False]:
        ...
...
class AlterConstraint(IndexOperation):
    category = ...
    option_name = ...
    def __init__(self, model_name, name, constraint) -> None:
        ...
    ...
    def reduce(self, operation, app_label) -> list[AlterConstraint | RemoveConstraint] | list[Any] | list[Self] | Literal[False]:
        ...
