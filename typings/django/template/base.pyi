...
class Template:
    ...
    def get_exception_info(self, exception, token) -> dict[str, str | list[Any] | int | Any]:
        """
...
class FilterExpression:
    ...
    def resolve(self, context, ignore_failures=...) -> __proxy__ | float | int | _Wrapped | SafeString | Variable | None:
        ...
...
class Variable:
    ...
    def resolve(self, context) -> __proxy__ | float | int | _Wrapped | SafeString | None:
