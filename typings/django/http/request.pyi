...
class HttpRequest:
    ...
    @cached_property
    def accepted_types(self) -> list[Any]:
    ...
    def accepted_type(self, media_type) -> None:
        """
        Return the MediaType instance which best matches the given media type.
        """
        ...
    
    def get_preferred_type(self, media_types) -> None:
    ...
    def build_absolute_uri(self, location=...) -> str | None:
        """
...
class MediaType:
    ...
    @cached_property
    def range_params(self) -> dict[Any, Any]:
        ...
    ...
    @cached_property
    def quality(self) -> float | Literal[1]:
        ...
    
    @property
    def specificity(self) -> Literal[0, 1, 2, 3]:
        """
